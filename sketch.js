...
var simA, rS, ratePara, vS, volPara, stopS, add, add2, addB, symbol, font, txt, voiceSp, caretC, fontsD;
function setup(){
...
simA.mousePressed(function(){
  let sum = parseInt(documentL[documentL.length-1])+parseInt(documentL[documentL.length-3]);
  documentL.pop();
  documentL.pop();
  documentL.pop();
  documentL.push(sum);
